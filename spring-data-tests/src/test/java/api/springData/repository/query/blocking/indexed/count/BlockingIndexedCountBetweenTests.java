...
@TestPropertySource(properties = {"indexedPersonSetName=personCountSetNameBetweenTestsIndexed"})
...
public class BlockingIndexedCountBetweenTests extends IndexedPersonRepositoryQueryTests {
    ...
    void countBySimplePropertyBetween_String() {
        assertThat(indexesCache.hasIndexFor(
                new IndexedField("source-ns21", "personCountSetNameBetweenTestsIndexed", "firstName"))
        ).isTrue();
