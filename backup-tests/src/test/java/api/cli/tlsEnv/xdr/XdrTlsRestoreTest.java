...
@Tag("BACKUP-TLS-ENV")
@Disabled
class XdrTlsRestoreTest extends CliBackupRunner {
    ...
    private static final String DC = "XdrTlsDC";
    private static final String BACKUP_DIR = "XdrTlsRestoreTest";
    ...
    void fastRestore() {
        ...
        BackupResult fastRestoreBackup = CliBackup.onWithXdrTls(SOURCE_NAMESPACE, BACKUP_DIR, DC, LOCAL_PORT).runWithTls();
