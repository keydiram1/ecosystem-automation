...
@Tag("XDR-CLI-BACKUP")
class XdrS3BackupRestoreTest extends CliBackupRunner {
    ...
    private static final String DC = "DcXdrS3BackupRestoreTest";
    private static final String BACKUP_DIR = "XdrS3BackupRestoreTestDir";
    ...
    void minioRestore() {
        ...
        BackupResult fastRestoreBackup = CliBackup.onWithXdr(SOURCE_NAMESPACE, BACKUP_DIR, true)
                .setLocalAddress()
                .setDc(DC)
                .setLocalPort(8086)
