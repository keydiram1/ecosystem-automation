...
@Tag("XDR-CLI-BACKUP")
class XdrRestoreEncryptedCompressedTest extends CliBackupRunner {
    private static final String STRING_BIN = "xdrCompressBin";
    private static final String SET_NAME = "xdrCompressTest";
    private static Key KEY1;
    private static String SOURCE_NAMESPACE = "source-ns7";

    private final int keys = 10_000;
    private final int recordSize = 500;
    private static final String BACKUP_DIR = "XdrRestoreEncryptedCompressedTest";
    private static final int LOCAL_PORT = 8089;
    private static final String DC128 = "DcEncrypted128";
    private static final String DC256 = "DcEncrypted256";
    ...
    void testEncryptionAndCompression128() {
        ...
        BackupResult backupResult = CliBackup.onWithXdr(SOURCE_NAMESPACE, BACKUP_DIR, DC128, LOCAL_PORT)
                .setEncryptionKeyFile()
                .setEncryptionMode("aes128")
    ...
    void testEncryptionAndCompression256() {
        ...
        BackupResult backupResult = CliBackup.onWithXdr(SOURCE_NAMESPACE, BACKUP_DIR, DC256, LOCAL_PORT).
