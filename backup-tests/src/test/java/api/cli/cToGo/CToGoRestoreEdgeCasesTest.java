...
class CToGoRestoreEdgeCasesTest extends CliBackupRunner {
    ...
    void restoreAllDataTypes() {
        ...
        String backupFilesPath = CToGoUtils.runBackupByConfiguration("restoreAllDataTypes", SOURCE_NAMESPACE);
    ...
    void restoreBigComplexRecord() {
        ...
        String backupFilesPath = CToGoUtils.runBackupByConfiguration("restoreBigComplexRecord", SOURCE_NAMESPACE);
