...
skip = "${local.common_vars.k8s.aerospike.backup_service.enabled}" == false && "${local.common_vars.k8s.aerospike.secret_manager.enabled}" == false ? true : false
