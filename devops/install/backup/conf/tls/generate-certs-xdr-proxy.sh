...
ORG='Aerospike, Inc.'
VALID_DAYS=30
CERT_DIR="./conf/tls/certs/xdrproxy"
AEROSPIKE_DIR="./conf/tls/xdrproxy"
...
openssl req -x509 -newkey ec:<(openssl ecparam -name prime256v1) -keyout ${CERT_DIR}/${PREFIX}.ca.key -out ${CERT_DIR}/${PREFIX}.ca.crt -days ${VALID_DAYS} -subj "/CN=${PREFIX}.ca/O=$ORG/C=US" -extensions v3_ca -passout pass:${PASSWORD}
